...
@Component({
    template: `
        <div class="test-container">
            <ng-container *uiContentLoading="loading$ | async"
                        [uiContentLoadingColor]="color"
                        [uiContentLoadingMode]="mode"
                        [uiContentLoadingValue]="value"
                        [uiContentLoadingDiameter]="diameter">
